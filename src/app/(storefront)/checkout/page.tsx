...
export default function CheckoutPage() {
  ...
  function buildWhatsAppMessage() {
    const linhas = cart
      .map(
        (i) =>
          `• ${i.product.name} × ${i.quantity} = MT ${(i.quantity * i.product.pricePerUnit).toLocaleString("pt-MZ", { minimumFractionDigits: 0 })}`,
      )
      .join("\n");
          ...
          <div className="max-w-md w-full text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-body-sm text-on-surface-variant mt-2 leading-relaxed">
                ...
                foi enviado via WhatsApp. O admin irá confirmar o pagamento e
            ...
            <div className="rounded-md border border-outline-variant bg-white p-4 text-left space-y-2">
                ...
                cart.map((i) => (
                  ...
                  >
                    ...
                    <span className="font-medium text-on-surface">
                      MT {(i.quantity * i.product.pricePerUnit).toLocaleString("pt-MZ")}
                      ,00
                    </span>
                  </div>
                ))
              ...
              <div className="flex justify-between text-body-sm border-t border-outline-variant pt-2 mt-2">
                ...
                <span className="font-medium text-on-surface">
                  MT {frete.toLocaleString("pt-MZ")},00
                </span>
              </div>
            ...
            <div className="rounded-md border border-outline-variant bg-surface-container-low p-4 text-left space-y-1">
              <p className="text-label-caps text-on-surface-variant uppercase tracking-widest mb-2">
                Próximos passos
              </p>
              <p className="text-body-sm text-on-surface">
                1. Transfira o valor via{" "}
                {metodo === "mpesa" ? "M-Pesa" : "e-Mola"} para o número do
                admin
              </p>
              <p className="text-body-sm text-on-surface">
                2. Envie o comprovativo pelo WhatsApp
              </p>
              <p className="text-body-sm text-on-surface">
                3. Aguarde confirmação e agendamento da entrega
              </p>
            </div>
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <nav className="bg-white border-b border-outline-variant sticky top-0 z-40">
        <div className="max-w-5xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
          ...
          <span className="text-[18px] font-bold text-on-surface tracking-tight">
            BlokManager
          </span>
          <span className="text-label-caps text-on-surface-variant hidden sm:block">
            Checkout
          </span>
        </div>
      </nav>
          ...
          {[
            ...
            <div key={s.n} className="flex items-center flex-1 last:flex-none">
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`text-label-caps font-semibold hidden sm:block ${s.n === step ? "text-on-surface" : "text-on-surface-variant"}`}
                >
                  {s.label}
                </span>
              </div>
              {i < 2 && (
                <div
                  className={`flex-1 h-px mx-3 ${s.n < step ? "bg-primary" : "bg-outline-variant"}`}
                />
              )}
            </div>
          ))}
        ...
        {step === 2 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-5">
              <div>
                <span className="text-label-caps text-primary font-semibold uppercase tracking-widest">
                  Passo 02
                </span>
                <h1 className="text-[24px] font-semibold text-on-surface mt-1">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  ...
                  <select
                    value={zona}
                    onChange={(e) => setZona(e.target.value as import("@/types").DeliveryZone)}
                  ...
                  >
                    {deliveryZones.map((z) => (
                      <option key={z.zone} value={z.zone}>
                        {z.zone} — MT {z.fee.toLocaleString("pt-MZ")}
                      </option>
                    ))}
                  </select>
                </div>
                ...
                <div className="space-y-2 border-t border-outline-variant pt-3">
                  {cart.map((i) => (
                    ...
                    >
                      ...
                      <span className="font-medium text-on-surface">
                        MT{" "}
                        {(i.quantity * i.product.pricePerUnit).toLocaleString(
                          "pt-MZ",
                        )}
                        ,00
                      </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              <div>
                ...
                <h2 className="text-[20px] font-semibold text-on-surface mt-1">
              ...
              <div className="grid grid-cols-2 gap-3 text-body-sm">
                <div>
                  <p className="text-label-caps text-on-surface-variant uppercase tracking-widest mb-1">
                    Zona
                  </p>
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  >
                    <div
                      className={`w-9 h-9 rounded-md ${m.color} flex items-center justify-center text-white font-bold text-[14px] flex-shrink-0`}
                    >
                      {m.label[0]}
                    </div>
              ...
              <div className="rounded-md border border-outline-variant bg-white p-4 space-y-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  />
                  <p className="text-label-caps text-on-surface-variant">
                    Para o admin confirmar a transferência.
                  </p>
                </div>
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-body-sm text-on-surface-variant leading-relaxed">
                    ...
                    e entendo que o material será entregue em até 48h úteis após
              ...
              <div className="flex items-center gap-3 rounded-md border border-outline-variant bg-surface-container-low px-4 py-3">
                ...
                <span className="text-label-caps text-on-surface-variant">
                  Ao confirmar, abriremos o WhatsApp com os detalhes do pedido
                  para enviar ao admin.
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-[20px] font-bold text-on-surface">
              MT {total.toLocaleString("pt-MZ")},00
            </p>
          </div>
      ...
      <div className="pb-24 bg-surface-container-low border-t border-outline-variant">
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-label-caps text-on-surface-variant">
            BlokManager Moz · © 2024 Todos os direitos reservados.
          </p>
          <div className="flex gap-6">
            <a
              href="#"
              className="text-label-caps text-on-surface-variant hover:text-primary underline"
            >
              WhatsApp Suporte
            </a>
            <a
